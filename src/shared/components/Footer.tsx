  ...
  return (
    <footer className="app-footer" role="contentinfo" aria-label="Uygulama altbilgisi">
      ...
      <p className="app-footer__text">
        Ham veriler (kur, enflasyon vb.) <a className="app-footer__link" href="https://evds2.tcmb.gov.tr/" target="_blank" rel="noopener noreferrer">TCMB EVDS</a>'den alınmıştır.
      </p>
